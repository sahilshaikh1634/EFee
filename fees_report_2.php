...
<body>
    ...
    <table  align="center" width="80%" border="1" style="margin-top:10px;">
     ...
     <?php   
       ...
       $class = $_SESSION["class"];
        ...
        $sql="SELECT * FROM `student_info` WHERE `class` LIKE '%$class%'";
 ...
 ?>        
            ...
            <h2 style="color:#ffff; weight:bold;">Total fees of class <u><?php echo $class;?></u>  is <u><?php echo $total;?></u> &#x20b9</h2>
            <h2 style="color:#ffff; weight:bold;">Paid fees of class <u><?php echo $class;?></u> is <u><?php echo $paid;?></u> &#x20b9</h2>
            <h2 style="color:#ffff; weight:bold;">Remaining fees of class <u><?php echo $class;?></u> is <u><?php echo $remain;?></u> &#x20b9</h2>
